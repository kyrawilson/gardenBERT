...
#Model used for EMNLP 2022: "deepset/bert-base-cased-squad2"
#models = ["ahotrod/electra_large_discriminator_squad2_512", "deepset/roberta-base-squad2", "deepset/bert-base-cased-squad2", "distilbert-base-cased-distilled-squad", "deepset/bert-large-uncased-whole-word-masking-squad2", "deepset/bert-base-uncased-squad2"]
...
models = ['twmkn9/bert-base-uncased-squad2', 'Shobhank-iiitdwd/bert-large-uncased-squad2-QA', 'deepset/roberta-base-squad2', 'deepset/roberta-large-squad2', 'deepset/bert-base-cased-squad2', "deepset/bert-large-uncased-whole-word-masking-squad2"]
...
for model_name in models:
    ...
    my_df.to_csv(f'new_GP_BERT_{model_name.split("/")[1]}.csv', index=False, header=['Code', 'Context', 'Question', 'Answer', 'Model_Ans', 'Score', 'Correct'])
